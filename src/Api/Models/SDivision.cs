...
{
    [DataContract]
    public partial class SDivisionDto : IEquatable<SDivisionDto>
    {
        [DataMember]
        [JsonPropertyName("id")]
        ...
        [DataMember]
        [JsonPropertyName("division_type_id")]
        ...
        // public MDivisionTypeDto? DivisionType { get; set; }

        public override string ToString()
        {
            var sb = new StringBuilder();
            sb.Append("class SDivisionDto {\n");
            sb.Append("  Id: ").Append(Id).Append('\n');
            sb.Append("  DelFlg: ").Append(DelFlg).Append('\n');
            sb.Append("  DivisionTypeId: ").Append(DivisionTypeId).Append('\n');
        ...
        public override bool Equals(object? obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SDivisionDto)obj);
        }

        public bool Equals(SDivisionDto? other)
        {
            ...
            return
                ...
                (DivisionTypeId == other.DivisionTypeId || (DivisionTypeId != null && DivisionTypeId.Equals(other.DivisionTypeId))) &&
                (SoId == other.SoId || (SoId != null && SoId.Equals(other.SoId))) &&
                (DeptId == other.DeptId || (DeptId != null && DeptId.Equals(other.DeptId))) &&
                (SortKey == other.SortKey || (SortKey != null && SortKey.Equals(other.SortKey))) &&
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                if (DivisionTypeId != null) hashCode = hashCode * 59 + DivisionTypeId.GetHashCode();
                if (SoId != null) hashCode = hashCode * 59 + SoId.GetHashCode();
                if (DeptId != null) hashCode = hashCode * 59 + DeptId.GetHashCode();
                if (SortKey != null) hashCode = hashCode * 59 + SortKey.GetHashCode();
...
#pragma warning disable 1591
        public static bool operator ==(SDivisionDto? left, SDivisionDto? right) => Equals(left, right);
        public static bool operator !=(SDivisionDto? left, SDivisionDto? right) => !Equals(left, right);
